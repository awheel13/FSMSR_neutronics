...
for i in range(255, 290, 5):
	...
	mycore = msfr.MSFR(e=ench, e2=0.002, salt="66.66%NaCl+33.34%UCl3")
	mycore.deplete = 100
	mycore.r = int(i)
	...
	copyfile('../run-serpent-msr.sh', './rep/first_fixed/run-serpent-msr.sh')
	os.chdir(rep_dir)
