...
for r in radii:
	...
	data_file = '%d/rep/first/msfr_res.m' % r
...
plt.errorbar(burn_years[0, :], keff[0, :], yerr=kerr[0, :], marker='o', mec='k', mew=0.6, ms=2, linewidth=2, color=refuel_colors[0], label=label_str[0])
plt.errorbar(burn_years[-1, :], keff[-1, :], yerr=kerr[-1, :], marker='o', mec='k', mew=0.6, ms=2, linewidth=2, color=refuel_colors[-1], label=label_str[-1])
...
plt.errorbar(burn_years[0, :], beta[0, :], yerr=beta_err[0, :], marker='o', mec='k', mew=0.6, ms=2, linewidth=2, color=refuel_colors[0], label=label_str[0])
plt.errorbar(burn_years[-1, :], beta[-1, :], yerr=beta_err[-1, :], marker='o', mec='k', mew=0.6, ms=2, linewidth=2, color=refuel_colors[-1], label=label_str[-1])
plt.xlabel('Full Power years')
...
plt.errorbar(burn_years[0, :], life[0, :], yerr=life_err[0, :], marker='o', mec='k', mew=0.6, ms=2, linewidth=2, color=refuel_colors[0], label=label_str[0])
plt.errorbar(burn_years[-1, :], life[-1, :], yerr=life_err[-1, :], marker='o', mec='k', mew=0.6, ms=2, linewidth=2, color=refuel_colors[-1], label=label_str[-1])
plt.xlabel('Full Power years')
...
for j in range(len(radii)):
	plt.errorbar(burn_years[j, :], life[j, :], yerr=life_err[0, :], marker='o', mec='k', mew=0.6, ms=2, linewidth=2, color=refuel_colors[j], label=label_str[j])
plt.xlabel('Full Power years')
plt.ylabel('Total Neutron Lifetime')
plt.ticklabel_format(axis="y", style="sci", scilimits=(0,0))
plt.legend()
...
for j in range(len(radii)):
	plt.errorbar(burn_years[j, :], beta[j, :], yerr=beta_err[0, :], marker='o', mec='k', mew=0.6, ms=2, linewidth=2, color=refuel_colors[j], label=label_str[j])
plt.xlabel('Full Power years')
plt.ylabel('Effective Delayed Neutron Fraction')
plt.legend()
plt.show()
